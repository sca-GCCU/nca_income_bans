...
twoway ///
	...
	, by(co_group, note("") legend(position(6))) ///
		xline(0, lpattern(dash) lcolor(black) lwidth(thin)) ///
		legend(order(1 "Pre" 2 "Post") rows(1)) ///
		xtitle("Earnings relative to Colorado threshold (\$`co_threshold_fmt') - High-Use Industries") ///		
		ytitle("Fraction") ///
		xlabel(`co_lo'(`co_w')`co_hi', labsize(small) angle(45) format(%9.0fc) nogrid) ///
		ylabel(, nogrid)
...
twoway ///
	...
	, by(co_group, note("") legend(position(6))) ///
		xline(`co_threshold', lpattern(dash) lcolor(black) lwidth(thin)) ///
		legend(order(1 "Pre" 2 "Post") rows(1)) ///
		xtitle("Earnings around Colorado threshold (\$`co_threshold_fmt') - High-Use Industries") ///		
		ytitle("Fraction") ///
		xlabel(0(`co_w')`co_upper', labsize(small) angle(45) format(%9.0fc) nogrid) ///
		ylabel(, nogrid)
...
twoway /// 
	...
	(histogram inc_rel if post_dc == 1 & inrange(inc_rel, `dc_lo', `dc_hi'-1), ///
		width(`dc_w') start(`dc_lo') fraction color(maroon%30)) /// 
	if !missing(dc_group) & high_use == 1 /// 
	, by(dc_group, note("") legend(position(6))) /// 
		xline(0, lpattern(dash) lcolor(black) lwidth(thin)) ///
		legend(order(1 "Pre" 2 "Post") rows(1)) ///	
		xtitle("Earnings relative to District of Columbia threshold (\$`dc_threshold_fmt') - High-Use Industries") ///		
		ytitle("Fraction") ///
		xlabel(`dc_lo'(`dc_w')`dc_hi', labsize(small) angle(45) format(%9.0fc) nogrid) ///
		ylabel(, nogrid)
graph export "output/figures/dc_vs_control_rel_incdist_prepost_hu.pdf", as(pdf) replace 
...
twoway ///
	...
	, by(dc_group, note("") legend(position(6))) ///
		xline(`dc_threshold', lpattern(dash) lcolor(black) lwidth(thin)) ///
		legend(order(1 "Pre" 2 "Post") rows(1)) ///
		xtitle("Earnings around District of Columbia threshold (\$`dc_threshold_fmt') - High-Use Industries") ///		
		ytitle("Fraction") ///
		xlabel(0(`dc_w')`dc_upper', labsize(small) angle(45) format(%9.0fc) nogrid) ///
		ylabel(, nogrid)
graph export "output/figures/dc_vs_control_abs_incdist_prepost_hu.pdf", as(pdf) replace
...
twoway /// 
	...
	(histogram inc_rel if post_me == 1 & inrange(inc_rel, `me_lo', `me_hi'-1), ///
		width(`me_w') start(`me_lo') fraction color(maroon%30)) /// 
	if !missing(me_group) & high_use == 1 /// 
	, by(me_group, note("") legend(position(6))) /// 
		xline(0, lpattern(dash) lcolor(black) lwidth(thin)) ///
		legend(order(1 "Pre" 2 "Post") rows(1)) ///	
		xtitle("Earnings relative to Maine threshold (\$`me_threshold_fmt') - High-Use Industries") ///		
		ytitle("Fraction") ///
		xlabel(`me_lo'(`me_w')`me_hi', labsize(small) angle(45) format(%9.0fc) nogrid) ///
		ylabel(, nogrid)
graph export "output/figures/me_vs_control_rel_incdist_prepost_hu.pdf", as(pdf) replace 
...
twoway ///
	...
	, by(me_group, note("") legend(position(6))) ///
		xline(`me_threshold', lpattern(dash) lcolor(black) lwidth(thin)) ///
		legend(order(1 "Pre" 2 "Post") rows(1)) ///
		xtitle("Earnings around Maine threshold (\$`me_threshold_fmt') - High-Use Industries") ///		
		ytitle("Fraction") ///
		xlabel(0(`me_w')`me_upper', labsize(small) angle(45) format(%9.0fc) nogrid) ///
		ylabel(, nogrid)
graph export "output/figures/me_vs_control_abs_incdist_prepost_hu.pdf", as(pdf) replace
...
twoway /// 
	...
	(histogram inc_rel if post_nh == 1 & inrange(inc_rel, `nh_lo', `nh_hi'-1), ///
		width(`nh_w') start(`nh_lo') fraction color(maroon%30)) /// 
	if !missing(nh_group) & high_use == 1 /// 
	, by(nh_group, note("") legend(position(6))) /// 
		xline(0, lpattern(dash) lcolor(black) lwidth(thin)) ///
		legend(order(1 "Pre" 2 "Post") rows(1)) ///	
		xtitle("Earnings relative to New Hampshire threshold (\$`nh_threshold_fmt') - High-Use Industries") ///		
		ytitle("Fraction") ///
		xlabel(`nh_lo'(`nh_w')`nh_hi', labsize(small) angle(45) format(%9.0fc) nogrid) ///
		ylabel(, nogrid)
graph export "output/figures/nh_vs_control_rel_incdist_prepost_hu.pdf", as(pdf) replace 
...
twoway ///
	...
	, by(nh_group, note("") legend(position(6))) ///
		xline(`nh_threshold', lpattern(dash) lcolor(black) lwidth(thin)) ///
		legend(order(1 "Pre" 2 "Post") rows(1)) ///
		xtitle("Earnings around New Hampshire threshold (\$`nh_threshold_fmt') - High-Use Industries") ///		
		ytitle("Fraction") ///
		xlabel(0(`nh_w')`nh_upper', labsize(small) angle(45) format(%9.0fc) nogrid) ///
		ylabel(, nogrid)
graph export "output/figures/nh_vs_control_abs_incdist_prepost_hu.pdf", as(pdf) replace
...
twoway /// 
	...
	(histogram inc_rel if post_ri == 1 & inrange(inc_rel, `ri_lo', `ri_hi'-1), ///
		width(`ri_w') start(`ri_lo') fraction color(maroon%30)) /// 
	if !missing(ri_group) & high_use == 1 /// 
	, by(ri_group, note("") legend(position(6))) /// 
		xline(0, lpattern(dash) lcolor(black) lwidth(thin)) ///
		legend(order(1 "Pre" 2 "Post") rows(1)) ///	
		xtitle("Earnings relative to Rhode Island threshold (\$`ri_threshold_fmt') - High-Use Industries") ///		
		ytitle("Fraction") ///
		xlabel(`ri_lo'(`ri_w')`ri_hi', labsize(small) angle(45) format(%9.0fc) nogrid) ///
		ylabel(, nogrid)
graph export "output/figures/ri_vs_control_rel_incdist_prepost_hu.pdf", as(pdf) replace 
...
twoway ///
	...
	, by(ri_group, note("") legend(position(6))) ///
		xline(`ri_threshold', lpattern(dash) lcolor(black) lwidth(thin)) ///
		legend(order(1 "Pre" 2 "Post") rows(1)) ///
		xtitle("Earnings around Rhode Island threshold (\$`ri_threshold_fmt') - High-Use Industries") ///		
		ytitle("Fraction") ///
		xlabel(0(`ri_w')`ri_upper', labsize(small) angle(45) format(%9.0fc) nogrid) ///
		ylabel(, nogrid)
graph export "output/figures/ri_vs_control_abs_incdist_prepost_hu.pdf", as(pdf) replace
...
twoway /// 
	...
	(histogram inc_rel if post_va == 1 & inrange(inc_rel, `va_lo', `va_hi'-1), ///
		width(`va_w') start(`va_lo') fraction color(maroon%30)) /// 
	if !missing(va_group) & high_use == 1 /// 
	, by(va_group, note("") legend(position(6))) /// 
		xline(0, lpattern(dash) lcolor(black) lwidth(thin)) ///
		legend(order(1 "Pre" 2 "Post") rows(1)) ///	
		xtitle("Earnings relative to Virginia threshold (\$`va_threshold_fmt') - High-Use Industries") ///		
		ytitle("Fraction") ///
		xlabel(`va_lo'(`va_w')`va_hi', labsize(small) angle(45) format(%9.0fc) nogrid) ///
		ylabel(, nogrid)
graph export "output/figures/va_vs_control_rel_incdist_prepost_hu.pdf", as(pdf) replace 
...
twoway ///
	...
	, by(va_group, note("") legend(position(6))) ///
		xline(`va_threshold', lpattern(dash) lcolor(black) lwidth(thin)) ///
		legend(order(1 "Pre" 2 "Post") rows(1)) ///
		xtitle("Earnings around Virginia threshold (\$`va_threshold_fmt') - High-Use Industries") ///		
		ytitle("Fraction") ///
		xlabel(0(`va_w')`va_upper', labsize(small) angle(45) format(%9.0fc) nogrid) ///
		ylabel(, nogrid)
graph export "output/figures/va_vs_control_abs_incdist_prepost_hu.pdf", as(pdf) replace
...
twoway /// 
	...
	(histogram inc_rel if post_wa == 1 & inrange(inc_rel, `wa_lo', `wa_hi'-1), ///
		width(`wa_w') start(`wa_lo') fraction color(maroon%30)) /// 
	if !missing(wa_group) & high_use == 1 /// 
	, by(wa_group, note("") legend(position(6))) /// 
		xline(0, lpattern(dash) lcolor(black) lwidth(thin)) ///
		legend(order(1 "Pre" 2 "Post") rows(1)) ///	
		xtitle("Earnings relative to Washington threshold (\$`wa_threshold_fmt') - High-Use Industries") ///		
		ytitle("Fraction") ///
		xlabel(`wa_lo'(`wa_w')`wa_hi', labsize(small) angle(45) format(%9.0fc) nogrid) ///
		ylabel(, nogrid)
graph export "output/figures/wa_vs_control_rel_incdist_prepost_hu.pdf", as(pdf) replace 
...
twoway ///
	...
	, by(wa_group, note("") legend(position(6))) ///
		xline(`wa_threshold', lpattern(dash) lcolor(black) lwidth(thin)) ///
		legend(order(1 "Pre" 2 "Post") rows(1)) ///
		xtitle("Earnings around Washington threshold (\$`wa_threshold_fmt') - High-Use Industries") ///		
		ytitle("Fraction") ///
		xlabel(0(`wa_w')`wa_upper', labsize(small) angle(45) format(%9.0fc) nogrid) ///
		ylabel(, nogrid)
graph export "output/figures/wa_vs_control_abs_incdist_prepost_hu.pdf", as(pdf) replace
...
twoway /// 
	...
	(histogram inc_rel if post1_il == 1 & inrange(inc_rel, `il_lo', `il_hi'-1), ///
		width(`il_w') start(`il_lo') fraction color(maroon%30)) /// 
	if !missing(il_group) & high_use == 1 /// 
	, by(il_group, note("") legend(position(6))) /// 
		xline(0, lpattern(dash) lcolor(black) lwidth(thin)) ///
		legend(order(1 "Pre" 2 "Post") rows(1)) ///	
		xtitle("Earnings relative to Illinois `il_ban_year1' threshold (\$`il_threshold1_fmt') - High-Use Industries") ///		
		ytitle("Fraction") ///
		xlabel(`il_lo'(`il_lab')`il_hi', labsize(small) angle(45) format(%9.0fc) nogrid) ///
		ylabel(, nogrid)
graph export "output/figures/il1_vs_control_rel_incdist_prepost_hu.pdf", as(pdf) replace 
...
twoway ///
	...
	, by(il_group, note("") legend(position(6))) ///
		xline(`il_threshold1', lpattern(dash) lcolor(black) lwidth(thin)) ///
		legend(order(1 "Pre" 2 "Post") rows(1)) ///
		xtitle("Earnings around Illinois `il_ban_year1' threshold (\$`il_threshold1_fmt') - High-Use Industries") ///		
		ytitle("Fraction") ///
		xlabel(0(`il_lab')`il_upper', labsize(small) angle(45) format(%9.0fc) nogrid) ///
		ylabel(, nogrid)
graph export "output/figures/il1_vs_control_abs_incdist_prepost_hu.pdf", as(pdf) replace
...
twoway /// 
	...
	, by(il_group, note("") legend(position(6))) /// 
		xline(0, lpattern(dash) lcolor(black) lwidth(thin)) ///
		legend(order(1 "Pre" 2 "Post") rows(1)) ///	
		xtitle("Earnings relative to Illinois `il_ban_year2' threshold (\$`il_threshold2_fmt') - High-Use Industries") ///		
		ytitle("Fraction") ///
		xlabel(`il_lo'(`il_lab')`il_hi', labsize(small) angle(45) format(%9.0fc) nogrid) ///
		ylabel(, nogrid)
graph export "output/figures/il2_vs_control_rel_incdist_prepost_hu.pdf", as(pdf) replace 
...
twoway ///
	...
	, by(il_group, note("") legend(position(6))) ///
		xline(`il_threshold2', lpattern(dash) lcolor(black) lwidth(thin)) ///
		legend(order(1 "Pre" 2 "Post") rows(1)) ///
		xtitle("Earnings around Illinois `il_ban_year2' threshold (\$`il_threshold2_fmt') - High-Use Industries") ///		
		ytitle("Fraction") ///
		xlabel(0(`il_lab')`il_upper', labsize(small) angle(45) format(%9.0fc) nogrid) ///
		ylabel(, nogrid)
graph export "output/figures/il2_vs_control_abs_incdist_prepost_hu.pdf", as(pdf) replace
...
twoway /// 
	...
	(histogram inc_rel if post1_md == 1 & inrange(inc_rel, `md_lo', `md_hi'-1), ///
		width(`md_w') start(`md_lo') fraction color(maroon%30)) /// 
	if !missing(md_group) & high_use == 1 /// 
	, by(md_group, note("") legend(position(6))) /// 
		xline(0, lpattern(dash) lcolor(black) lwidth(thin)) ///
		legend(order(1 "Pre" 2 "Post") rows(1)) ///	
		xtitle("Earnings relative to Maryland `md_ban_year1' threshold (\$`md_threshold1_fmt') - High-Use Industries") ///		
		ytitle("Fraction") ///
		xlabel(`md_lo'(`md_w')`md_hi', labsize(small) angle(45) format(%9.0fc) nogrid) ///
		ylabel(, nogrid)
graph export "output/figures/md1_vs_control_rel_incdist_prepost_hu.pdf", as(pdf) replace 
...
twoway ///
	...
	, by(md_group, note("") legend(position(6))) ///
		xline(`md_threshold1', lpattern(dash) lcolor(black) lwidth(thin)) ///
		legend(order(1 "Pre" 2 "Post") rows(1)) ///
		xtitle("Earnings around Maryland `md_ban_year1' threshold (\$`md_threshold1_fmt') - High-Use Industries") ///		
		ytitle("Fraction") ///
		xlabel(0(`md_w')`md_upper', labsize(small) angle(45) format(%9.0fc) nogrid) ///
		ylabel(, nogrid)
graph export "output/figures/md1_vs_control_abs_incdist_prepost_hu.pdf", as(pdf) replace
...
twoway /// 
	...
	, by(md_group, note("") legend(position(6))) /// 
		xline(0, lpattern(dash) lcolor(black) lwidth(thin)) ///
		legend(order(1 "Pre" 2 "Post") rows(1)) ///	
		xtitle("Earnings relative to Maryland `md_ban_year2' threshold (\$`md_threshold2_fmt') - High-Use Industries") ///		
		ytitle("Fraction") ///
		xlabel(`md_lo'(`md_w')`md_hi', labsize(small) angle(45) format(%9.0fc) nogrid) ///
		ylabel(, nogrid)
graph export "output/figures/md2_vs_control_rel_incdist_prepost_hu.pdf", as(pdf) replace 
...
twoway ///
	...
	, by(md_group, note("") legend(position(6))) ///
		xline(`md_threshold2', lpattern(dash) lcolor(black) lwidth(thin)) ///
		legend(order(1 "Pre" 2 "Post") rows(1)) ///
		xtitle("Earnings around Maryland `md_ban_year2' threshold (\$`md_threshold2_fmt') - High-Use Industries") ///		
		ytitle("Fraction") ///
		xlabel(0(`md_w')`md_upper', labsize(small) angle(45) format(%9.0fc) nogrid) ///
		ylabel(, nogrid)
graph export "output/figures/md2_vs_control_abs_incdist_prepost_hu.pdf", as(pdf) replace
...
twoway /// 
	...
	(histogram inc_rel if post1_or == 1 & inrange(inc_rel, `or_lo', `or_hi'-1), ///
		width(`or_w') start(`or_lo') fraction color(maroon%30)) /// 
	if !missing(or_group) & high_use == 1 /// 
	, by(or_group, note("") legend(position(6))) /// 
		xline(0, lpattern(dash) lcolor(black) lwidth(thin)) ///
		legend(order(1 "Pre" 2 "Post") rows(1)) ///	
		xtitle("Earnings relative to Oregon `or_ban_year1' threshold (\$`or_threshold1_fmt') - High-Use Industries") ///		
		ytitle("Fraction") ///
		xlabel(`or_lo'(`or_w')`or_hi', labsize(small) angle(45) format(%9.0fc) nogrid) ///
		ylabel(, nogrid)
graph export "output/figures/or1_vs_control_rel_incdist_prepost_hu.pdf", as(pdf) replace 
...
twoway ///
	...
	, by(or_group, note("") legend(position(6))) ///
		xline(`or_threshold1', lpattern(dash) lcolor(black) lwidth(thin)) ///
		legend(order(1 "Pre" 2 "Post") rows(1)) ///
		xtitle("Earnings around Oregon `or_ban_year1' threshold (\$`or_threshold1_fmt') - High-Use Industries") ///		
		ytitle("Fraction") ///
		xlabel(0(`or_w')`or_upper', labsize(small) angle(45) format(%9.0fc) nogrid) ///
		ylabel(, nogrid)
graph export "output/figures/or1_vs_control_abs_incdist_prepost_hu.pdf", as(pdf) replace
...
twoway /// 
	...
	, by(or_group, note("") legend(position(6))) /// 
		xline(0, lpattern(dash) lcolor(black) lwidth(thin)) ///
		legend(order(1 "Pre" 2 "Post") rows(1)) ///	
		xtitle("Earnings relative to Oregon `or_ban_year2' threshold (\$`or_threshold2_fmt') - High-Use Industries") ///		
		ytitle("Fraction") ///
		xlabel(`or_lo'(`or_w')`or_hi', labsize(small) angle(45) format(%9.0fc) nogrid) ///
		ylabel(, nogrid)
graph export "output/figures/or2_vs_control_rel_incdist_prepost_hu.pdf", as(pdf) replace 
...
twoway ///
	...
	, by(or_group, note("") legend(position(6))) ///
		xline(`or_threshold2', lpattern(dash) lcolor(black) lwidth(thin)) ///
		legend(order(1 "Pre" 2 "Post") rows(1)) ///
		xtitle("Earnings around Oregon `or_ban_year2' threshold (\$`or_threshold2_fmt') - High-Use Industries") ///		
		ytitle("Fraction") ///
		xlabel(0(`or_w')`or_upper', labsize(small) angle(45) format(%9.0fc) nogrid) ///
		ylabel(, nogrid)
graph export "output/figures/or2_vs_control_abs_incdist_prepost_hu.pdf", as(pdf) replace
